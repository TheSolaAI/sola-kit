...
export const luloToolSetFactory = createToolSetFactory(
  {
    ...
    name: 'Lulo',
    description:
      'Tools for providing information on Lulo, a yeild aggregator on Solana. Allows users to get their lulo assets, withdraw and deposit assets. Only used if an user specifies that they want to operate on their Lulo account.',
  },
  {
